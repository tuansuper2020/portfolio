  ...
  return (
    <section className="bg-black text-white py-20">
      <div className="max-w-[980px] mx-auto px-6 text-center">
        <p className="text-caption uppercase tracking-[0.2em] text-[#2997ff] mb-3">
          Stack
        </p>
        <h2 className="display-tile text-white mb-12 max-w-2xl mx-auto">
